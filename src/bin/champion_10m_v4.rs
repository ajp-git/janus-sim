//! Champion 10M run v4 — FFT Zeldovich ICs + RANDOM Signs
//!
...
//! Signs: RANDOM (matching scan v4 configuration)
...
fn run_champion() {
    println!("========================================================");
    println!("  CHAMPION 10M v4 — FFT ICs + RANDOM Signs");
    println!("========================================================");
    ...
    let base_dir = std::path::Path::new("/app/output/champion_10m_v4");
    ...
    println!();
    println!("========================================================");
    println!("  CHAMPION 10M v4 COMPLETE");
    println!("========================================================");
...
fn generate_fft_zeldovich_ics(seed: u64) -> (Vec<f64>, Vec<f64>, Vec<i32>, usize) {
    ...
    // RANDOM sign assignment (like scan v4)
    println!("  Assigning RANDOM signs (like scan v4)...");

    // Build particles with RANDOM signs
