...
- Run A (η=1.045) et Run B (η=2.03) en cours sur 10 000 steps ✅

### Problème central identifié
Run A montre ségrégation qui monte (+7.8% à step 500)
puis redescend (-19.8% à step 2000).

Trois causes probables identifiées par Gemini/ChatGPT/Grok :
1. Conditions initiales non virialisées (Seg₀ ≈ 0.49 artificiel)
2. Absence de Hubble friction (univers statique au lieu d'expansif)
3. Régime quasi-symétrique η≈1 (forces positives/négatives presque égales)

---

## TÂCHE 1 — CONDITIONS INITIALES VIRIALISÉES
### Priorité : CRITIQUE — À faire avant toute nouvelle simulation
