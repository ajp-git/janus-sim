//! JANUS V16 — Thick Filaments Test
//! 30M particles, L=500 Mpc, k_min=10 (λ_min=50 Mpc), z=5→0
//! Goal: Thicker filaments (50 Mpc) with 30M particles should persist to z=0
...
const N_GRID: usize = 310;  // 310³ = 29,791,000 ≈ 30M particles
const ETA: f64 = 1.045;
const ALPHA_IC: f64 = 1.6;  // standard velocity amplitude
const EPSILON: f64 = 0.25;  // softening for 3M
const THETA: f64 = 0.7;     // faster tree (was 0.5)
...
const K_MIN_IC: usize = 10; // ICs: start at mode 10 → λ_min = 50 Mpc (thick filaments)
...
fn main() {
    ...
    println!("╔═══════════════════════════════════════════════════════════╗");
    println!("║  JANUS V16 — THICK FILAMENTS | 30M | k_min=10 | L=500   ║");
    println!("╚═══════════════════════════════════════════════════════════╝");
