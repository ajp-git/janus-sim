//! Champion 10M run v3 — FFT Zeldovich ICs + RANDOM Signs
//!
...
fn run_champion() {
    println!("========================================================");
    println!("  CHAMPION 10M v3 — FFT ICs + RANDOM Signs");
    println!("========================================================");
    ...
    let base_dir = std::path::Path::new("/app/output/champion_10m_v3");
    ...
    println!();
    println!("========================================================");
    println!("  CHAMPION 10M v3 COMPLETE");
    println!("========================================================");
