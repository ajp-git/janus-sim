//! T_floor test: T_floor_minus = 1000 K (×10)
...
const T_FLOOR_MINUS: f64 = 1000.0;  // ×10
...
#[cfg(feature = "cuda")]
fn run_test() {
    let output_dir = "/app/output/tfloor_test_1k";
    create_dir_all(output_dir).unwrap();

    println!("T_floor_minus = 1000 K (×10)");
