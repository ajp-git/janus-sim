//! JANUS V14 — Filament Test
//! 3M particles, L=500 Mpc, k_min=20, z=5→0
//! Goal: Enable filament formation with k_min=20 (λ_min = 500/20 = 25 Mpc)
...
fn main() {
    ...
    let out = "/app/output/janus_v14_500Mpc_3M_kmin20";
    fs::create_dir_all(format!("{}/snapshots", out)).unwrap();
    fs::create_dir_all(format!("{}/fields", out)).unwrap();

    println!("╔═══════════════════════════════════════════════════════════╗");
    println!("║  JANUS V14 — FILAMENT TEST | 3M | k_min=20 | L=500       ║");
    println!("╚═══════════════════════════════════════════════════════════╝");
