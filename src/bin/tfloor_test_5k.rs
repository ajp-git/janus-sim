//! T_floor test: T_floor_minus = 5000 K (×50)
...
const T_FLOOR_MINUS: f64 = 5000.0;  // ×50
...
#[cfg(feature = "cuda")]
fn run_test() {
    let output_dir = "/app/output/tfloor_test_5k";
    create_dir_all(output_dir).unwrap();

    println!("T_floor_minus = 5000 K (×50)");
