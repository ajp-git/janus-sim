#!/usr/bin/env python3
"""
3D Visualization of Janus Polarization Domains - Step 1000
...
INPUT_DIR = "/mnt/T2/janus-sim/analysis_v10_snapshot1000"
OUTPUT_DIR = "/mnt/T2/janus-sim/analysis_v10_snapshot1000"
L_BOX = 200.0

print("Loading polarization field (step 1000)...")
...
ax.set_title('Janus Polarization Domains (V10 step 1000)', fontsize=16)
