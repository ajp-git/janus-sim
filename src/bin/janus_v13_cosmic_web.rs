//! JANUS V13 — Cosmic Web Formation
//! 5M particles, L=200 Mpc, z=10→0
...
const DT: f64 = 0.01;
const Z_INIT: f64 = 5.0;  // z=10 unstable for η=1.045, use z=5
