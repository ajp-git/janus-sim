//! High-resolution 20M Janus simulation - μ = 19, Box = 100 Mpc
//!
//! Usage: cargo run --release --features "cuda cufft" --bin janus_hires_100mpc
...
const MU: f64 = 19.0;
const BOX_SIZE: f64 = 100.0;  // 10× smaller for high resolution
const Z_INIT: f64 = 4.0;
const DT: f64 = 0.005;
const STEPS: usize = 4000;    // 2× more steps
const THETA: f64 = 0.7;
const SOFTENING: f64 = 0.001; // 10× smaller softening for small box
const SEED: u64 = 42;
...
#[cfg(feature = "cuda")]
fn main() {
    let run_name = "hires_100mpc".to_string();

    println!("================================================================");
    println!("  JANUS 20M HIGH-RES 100Mpc — μ = {}", MU);
    println!("================================================================");
