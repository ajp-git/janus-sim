//! Petit Pure 20M — μ=8, λ=0, Uniform Random ICs
//!
//! Production run to validate Petit foam structure:
//! - 20M particles for filament resolution
//! - Multiple m⁻ spheroids expected (not single blob)
//! - Soap bubble foam morphology
...
fn main() {
    println!("========================================================");
    println!("  PETIT PURE 20M — μ={}, λ=0, Foam Structure Test", MU);
    println!("========================================================");
    ...
    // Setup output
    let base_dir = std::path::Path::new("/app/output/petit_pure_20m");
    ...
    println!();
    println!("========================================================");
    println!("  PETIT PURE 20M COMPLETE");
    println!("========================================================");
