#!/usr/bin/env python3
"""
4K Composite Frame Renderer for Janus Simulation
Layout: 3840×2160 with 3 columns
"""
...
def render_composite(snap_path, output_path):
    ...
    # Header
    fig.suptitle(f'η={ETA}, λ₀={LAMBDA_0} Mpc  |  z={z:.2f}  |  P={P:.3f}  |  step {step}/{TOTAL_STEPS}',
...
def main():
    snap_dir = Path("/mnt/T2/janus-sim/output/champion_10m_v2/snapshots")
    out_dir = Path("/mnt/T2/janus-sim/output/champion_10m_v2/frames_composite")
    out_dir.mkdir(parents=True, exist_ok=True)

    processed = set()

    print("Starting composite renderer...")
